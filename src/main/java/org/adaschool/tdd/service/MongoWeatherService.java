...
import org.adaschool.tdd.exception.EMessage;
...
public class MongoWeatherService implements WeatherService {
    ...
    public WeatherReport findById( String id ) throws WeatherReportNotFoundException{
        WeatherReport weatherReport = repository.findById(id).orElseThrow(()-> new WeatherReportNotFoundException(EMessage.WEATHER_ID_NOT_FOUND));
    ...
    @Override
    public List<WeatherReport> findWeatherReportByReporter(String reporter) {
        List<WeatherReport> weatherReportList = repository.findWeatherReportByReporter(reporter);
